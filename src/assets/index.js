export { default as srcAvatar } from './images/avatar.png'

export { default as srcClub1 } from './images/clubs/1.png'
export { default as srcClub2 } from './images/clubs/2.png'
export { default as srcClub3 } from './images/clubs/3.png'
export { default as srcClub4 } from './images/clubs/4.png'
export { default as srcClub5 } from './images/clubs/5.png'
